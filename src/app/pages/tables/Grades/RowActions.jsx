...
//                 // setGradeOptions(data.data?.grades || []);
//                 const gradesArray = data?.data?.grades;
//       if (Array.isArray(gradesArray)) {
//         setGradeOptions(gradesArray);
//       } else {
//         console.warn("Unexpected grade format", data);
//         setGradeOptions([]);
//       }
//                 // Expected: { grades: ["A+", "A", "B"] }
//             } catch (err) {
